    ...
    const contactsSubscription = supabase
      ...
      .on('postgres_changes', { 
        ...
        if (payload.eventType === 'INSERT') {
          // For new messages, refresh to get accurate count and pagination
          fetchMessages();
        } else if (payload.eventType === 'UPDATE') {
          // For updates, we can just update the specific message
          ...
          // For deletes, filter out the deleted message
          setMessages(prevMessages => 
            prevMessages.filter(msg => msg.id !== payload.old.id)
          );
          
          // Close dialog if the deleted message is being viewed
          if (selectedMessage && selectedMessage.id === payload.old.id) {
            handleCloseDialog();
          }
        }
      })
