                    ...
                    >
                        ...
                        <List disablePadding>
                            <ListItem disablePadding>
                                ...
                                >
                                    <ListItemIcon>
                                        <SvgIcon name="tabler-dashboard" />
                                    </ListItemIcon>
                                    <ListItemText
                                        primary="Admin Dashboard"
                                        secondary="Access the admin control panel"
                                    />
                                </ListItemButton>
                            </ListItem>
                            ...
                            <ListItem disablePadding>
                                ...
                                >
                                    <ListItemIcon>
                                        <SvgIcon name="tabler-user-plus" />
                                    </ListItemIcon>
                                    <ListItemText
                                        primary="Create Admin User"
                                        secondary="Set up additional administrator accounts"
                                    />
                                </ListItemButton>
                            </ListItem>
                        </List>
