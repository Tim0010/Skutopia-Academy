...
const menuItems = [
    ...
    { title: 'Mentorship', icon: 'tabler-users', path: '/dashboard/mentorship' },
    { title: 'My Sessions', icon: 'tabler-calendar', path: '/dashboard/my-sessions' },
    { title: 'Past Papers', icon: 'tabler-file', path: '/dashboard/exam-papers' },
                        ...
                        {user && (
                            <>
                                ...
                                >
                                    <MenuItem>
                                        <ListItemIcon>
                                            <SvgIcon icon="tabler-user" />
                                        </ListItemIcon>
                                        <ListItemText primary="Profile" />
                                    </MenuItem>
                                    <MenuItem>
                                        <ListItemIcon>
                                            <SvgIcon icon="tabler-settings" />
                                        </ListItemIcon>
