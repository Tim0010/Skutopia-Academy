...
const description = `${branding.brandName} ${branding.title} is an advanced learning platform designed to help students master STEM subjects through interactive courses, personalized mentorship, and adaptive learning paths. Our platform offers comprehensive courses in science, technology, engineering, and mathematics with expert guidance to accelerate your learning journey.`;

const ogCommonMetadata = {
  locale: 'en_US',
  type: 'website',
  siteName: `${branding.brandName} ${branding.title}`,
