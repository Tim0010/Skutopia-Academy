    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Monitor and manage discussions across all your courses
        </p>
      </div>
        ...
        {filteredCourses.map((course) => (
          <Card key={course._id}>
            ...
            <CardContent>
              <div className="flex items-center gap-4 text-sm text-muted-foreground">
                <div className="flex items-center gap-1">
                  ...
                  <span>
                    {course.discussionStats?.totalDiscussions || 0} Discussions
                  </span>
                </div>
                <div className="flex items-center gap-1">
                  <CheckCircle className="h-4 w-4" />
                  <span>
                    {course.discussionStats?.resolvedDiscussions || 0} Resolved
                  </span>
                </div>
              </div>
            </CardContent>
            <CardFooter>
              ...
              >
                <Link
                  to={`/instructor/dashboard/courses/${course._id}?tab=discussions`}
                >
                  View Discussions
                </Link>
              </Button>
